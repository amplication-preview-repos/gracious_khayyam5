...
import { SendTelegramNotificationInput } from "../SendTelegramNotificationInput";
...
export class NotificationControllerBase {
  ...
  @common.Post("/sendTelegramNotification")
  ...
  async SendTelegramNotification(
    @common.Body()
    body: SendTelegramNotificationInput
  ): Promise<Notification> {
    return this.service.SendTelegramNotification(body);
  }
}
